"""
Resume upload page — placeholder. Real content in Phase 19d.
"""
...
def main() -> None:
    ...
    render_sidebar()
    render_header(subtitle="Upload your resume")
    ...
    st.markdown(
        ...
        <div class='card'>
            ...
            <p class='muted'>Coming soon — resume upload and analysis.</p>
        </div>
        """,
